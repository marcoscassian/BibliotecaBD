...
def criar_triggers():
    ...
    # TRIGGER 11
    # Validação do e-mail do usuário (obrigatório e formato válido)
    cursor.execute("""
    ...
    # TRIGGER 12
    # Validar se a multa inicial do usuário não é negativa
    cursor.execute("""
    ...
    # TRIGGER 13
    # Validar consistência das datas do empréstimo
    cursor.execute("""
    ...
    # TRIGGER 14
    # Bloquear empréstimo duplicado do mesmo livro para o mesmo usuário
    cursor.execute("""
    ...
    # TRIGGER 15
    # Validar se o usuário está apto a realizar empréstimos
    cursor.execute("""
